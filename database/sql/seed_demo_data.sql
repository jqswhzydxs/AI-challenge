...
VALUES
  (1000000000000000002, 'ADMIN', '系统管理员', 'ENABLE', 0, '联调默认角色'),
  (1000000000000000006, 'USER', '普通用户', 'ENABLE', 0, '联调默认角色')
ON DUPLICATE KEY UPDATE
...
VALUES
  ...
  (1000000000000000009, 1000000000000000005, 1000000000000000006)
