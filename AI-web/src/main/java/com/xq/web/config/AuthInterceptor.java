...
/**
 * JWT authentication and coarse role authorization.
 */
@Slf4j
@Component
public class AuthInterceptor implements HandlerInterceptor {
    ...
    private static final String SYSTEM_USERS_PATH = "/api/system/users";
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        ...
        request.setAttribute("role", UserRole.canonicalRole(role));
    ...
    private boolean hasAccess(String uri, String role) {
        ...
        if (uri.startsWith(SYSTEM_USERS_PATH)) {
            return UserRole.isAdmin(role);
        }
        return UserRole.isAdmin(role) || UserRole.isUser(role);
    }
