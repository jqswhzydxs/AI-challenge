...
public interface ProductionScheduleService {
    ...
    Result<TaskVO> generateFromCollectedData(ScheduleGenerateDTO dto);

    Result<TaskVO> generateFromRawData(byte[] fileBytes, String originalFilename, String scheduleDate);
